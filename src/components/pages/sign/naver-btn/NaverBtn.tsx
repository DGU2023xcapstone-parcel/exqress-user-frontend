...
const NaverBtn = () => {
  ...
  const NAVER_CLIENT_ID = "M5Xw0s8ZqMO9Rv1dEkls"; // 발급 받은 Client ID 입력
  const NAVER_CALLBACK_URL = "http://localhost:5173/signin"; // 작성했던 Callback URL 입력
  ...
  return (
    <>
      <div id="naverIdLogin" />
      {/* <style.NaverIdLogin ref={naverRef} id="naverIdLogin" />
      <style.NaverLoginBtn onClick={handleNaverLogin}>
        <style.NaverIcon />
      </style.NaverLoginBtn> */}
    </>
  );
